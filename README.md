...
![Language: JavaScript](https://img.shields.io/badge/Language-JavaScript-orange.svg)

這是一款使用 Vanilla HTML5 Canvas、CSS 與 JavaScript 開發的惡搞街機風網頁遊戲。玩家將扮演站在天台上的主角，以強力的「吐痰」作為武器，反擊地面的行人和各種強大的關卡魔王！
